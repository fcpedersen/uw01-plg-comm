<?php
/*
This file is a nmfc category file.
...
// category list
$terms = get_terms(array('taxonomy'=>'commodities_nmfc','hide_empty'=>true));
?>
		<main>
			<!-- =========================================================================== -->
			<!-- HEADER: Start ============================================================= -->
					...
					<div class="row py-5">
						<div class="col-12">
							...
							<!-- 	$header_title Start ================================================
								...
								Freight NMFC: <code><?php echo single_cat_title("", false);?></code>
							<!-- 	$header_title: End ================================================= -->
							</h1>
							<p class="lead">
								<!-- 	$header_subtitle Start ============================================= -->
								Learn about shipping freight NMFC <code><?php echo single_cat_title("", false);?></code>
								<!-- 	$header_subtitle: End ============================================== -->
							</p>
				...
				<!-- BREADCRUMB: Start ===================================================== -->
						...
						<div class="col-12">
							<nav aria-label="breadcrumb">
								<!-- <ol class="breadcrumb px-0 bg-transparent border-bottom">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="<?php //echo site_url() . '/nmfc';?>">nmfc</a></li>
					...
					<div class="row pb-5 classpbs">
						...
						<!-- 	POSTS | TAXONOMY ITEMS: Start ======================================
							...
							<h5 class="py-3 mb-0 border-bottom border-secondary">Commonly Shipped NMFC <code><?php echo single_cat_title("", false);?></code> Items</h5>
						...
						List of other TAXONOMY                     -->
							<h5 class="pb-3 mb-0 border-bottom border-secondary">Other Freight NMFCes</h5>
							<ul class="list-group list-group-flush">
								<?php
								if(!empty($terms)){
